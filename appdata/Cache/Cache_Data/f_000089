...
Blockly.Arduino.AirsenseReadTempBME280 = function(){
  ...
  Blockly.Arduino.addDeclaration('BME280_object','Adafruit_BMP280 bmp280;',false);// Wire.begin(I2C_SDA, I2C_SCL);
  Blockly.Arduino.addSetup('BME280_setup_PORT_I2C','Wire.begin(I2C_PORT_SDA, I2C_PORT_SC);',false);
  Blockly.Arduino.addSetup('BME280_setup','bmp280.begin(BMP280_I2C_ADDRESS);',false);


  var code = 'float temperature = bmp280.readTemperature();';
  return code;
};
...
Blockly.Arduino.freeRTOS = function(){
  ...
  Blockly.Arduino.addDeclaration('Task','void TaskBlink(void *pvParameters);',false);

  // Generate the code for the block
  return code ;
};

Blockly.Arduino.AirsenseReadPMS7003 = function () {
